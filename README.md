...
- **Android / Chrome / Edge**: aparecerá el botón **Instalar** cuando el navegador permita la instalación PWA.
- **iPhone / iPad (Safari)**: usa **Compartir > Añadir a pantalla de inicio**. El paquete ya incluye `apple-touch-icon`, modo standalone y metadatos Apple.
- **PC (Chrome / Edge)**: aparecerá el botón **Instalar** en la web o en la barra del navegador.
